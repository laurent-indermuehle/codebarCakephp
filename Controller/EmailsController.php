 ...
 */
	public function add() {
		...
		$loans = $this->Email->Loan->find('list');
		$interventions = $this->Email->Intervention->find('list');
		$toPeople = $this->Email->ToPerson->find('list');
		$fromPeople = $this->Email->FromPerson->find('list');
		$this->set(compact('loans', 'interventions', 'toPeople', 'fromPeople'));
	}
