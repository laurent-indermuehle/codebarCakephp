...
<?php echo $this->Form->create('ExternalInterventionNumber');?>
	<fieldset>
		<legend><?php echo __('Edit External Intervention Number'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('ExternalInterventionNumber.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('ExternalInterventionNumber.id'))); ?></li>
