...
<?php echo $this->Form->create('LoanArticle');?>
	<fieldset>
		<legend><?php echo __('Edit Loan Article'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('LoanArticle.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('LoanArticle.id'))); ?></li>
