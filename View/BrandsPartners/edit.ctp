...
<?php echo $this->Form->create('BrandsPartner');?>
	<fieldset>
		<legend><?php echo __('Edit Brands Partner'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('BrandsPartner.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('BrandsPartner.id'))); ?></li>
