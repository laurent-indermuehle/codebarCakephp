<div class="diagnostics index">
	...
	<tr>
		...
		<td><?php echo h($diagnostic['Diagnostic']['question']); ?>&nbsp;</td>
		<td><?php echo h($diagnostic['Diagnostic']['description']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $diagnostic['Diagnostic']['id']), null, __('Are you sure you want to delete # %s?', $diagnostic['Diagnostic']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
