...
<?php echo $this->Form->create('InterventionsProblem');?>
	<fieldset>
		<legend><?php echo __('Edit Interventions Problem'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('InterventionsProblem.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('InterventionsProblem.id'))); ?></li>
