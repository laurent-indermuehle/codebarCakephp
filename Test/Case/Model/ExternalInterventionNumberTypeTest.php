<?php
App::uses('ExternalInterventionNumberType', 'Model');

/**
 * ExternalInterventionNumberType Test Case
 *
 */
class ExternalInterventionNumberTypeTestCase extends CakeTestCase {
/**
 * Fixtures
 *
 * @var array
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->ExternalInterventionNumberType = ClassRegistry::init('ExternalInterventionNumberType');
	}
 ...
 */
	public function tearDown() {
		unset($this->ExternalInterventionNumberType);
